...
static bool insideTriangle(int x, int y, const Vector3f* _v) {
    ...
    Eigen::Vector3f s1 = _v[1] - _v[0], s2 = _v[2] - _v[1], s3 = _v[0] - _v[2]; //三角形的三条边
    Eigen::Vector3f p(x, y, 1); //被检测的点
    Eigen::Vector3f a1 = p - _v[0], a2 = p - _v[1], a3 = p - _v[2];
    a1 = s1.cross(a1);a2 = s2.cross(a2);a3 = s3.cross(a3);
